...
class LosTitularesSiguenSiendoCiertos(unittest.TestCase):
    ...
    def test_8_el_plugin_ejecuta_los_programas_que_dice(self):
        """§0.8: «quince programas, de los cuales nueve se exponen».
        ...
        self.assertEqual(15, len(programas), programas)
        self.assertIn(u"quince programas", seccion0())
        self.assertIn(u"nueve se exponen al modelo", seccion0())
