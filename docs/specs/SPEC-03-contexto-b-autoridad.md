...
| R-2 | **Simetría obligatoria en posición de autoridad**, **hacia las demás partes y hacia sus propios actos**. Una carencia señalada de una parte se busca en las demás y **el resultado se escribe, la haya o no**; y cuando el reparto de hallazgos queda desigual, **se dice con los números**, porque el sesgo suele ser material —una parte aportó diecinueve páginas y la otra cuatro— y no de mérito. **Esta regla no es nueva:** `revision-de-rigor` §2.3 la tiene desde antes y **manda su redacción** | `revision-de-rigor` §2.3 · **el pase real del 27/08**, donde funcionó |
