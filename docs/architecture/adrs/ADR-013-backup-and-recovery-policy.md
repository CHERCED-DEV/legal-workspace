...
3. **Retención: cuántas copias se guardan y cuánto tiempo.** V0 hereda «no borrar nada» (`18` §6.3), lo que es correcto hoy y **no es sostenible indefinidamente** (riesgo 5). Falta decidir el criterio (por número, por antigüedad, o por espacio), quién lo ejecuta —dado que ninguna operación automática de V0 borra— y qué se le dice a ella cuando ocurra.
