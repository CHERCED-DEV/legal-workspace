...
|---|---|---|---|---|---|
| **OD-01** | Amendment de `CaseRevision`: `event_seq` vs `case_revision` | **SÍ** | B1 | **Dueños** (amendment de ADR-004 y ADR-005, Accepted) | kernel §5.2; `01` §9.2; `04` §10 C3 |
