...
| | Qué |
|---|---|
| **El producto** | De seis métodos a **trece**, con **veintiún programas** que hacen el trabajo mecánico —**diez expuestos al modelo**, once de correr a mano—. **Doce specs** escritas y ejecutadas |
