...
| | Qué |
|---|---|
| **El producto** | De seis métodos a **trece**, con **dieciséis programas** que hacen el trabajo mecánico —**diez expuestos al modelo**, seis de correr a mano—. **Doce specs** escritas y ejecutadas |
